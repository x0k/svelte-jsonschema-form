import{o as e}from"./advanced-examples.CKkFjXjg.js";import"./_commonjsHelpers.aYOyWGRt.js";import"./render.rETKdxi5.js";import"./function.BB_gY1-Q.js";import"./shared.Ct9bVc-i.js";import"./preload-helper._QpxS67N.js";import"./buttons.S2iWoOtv.js";/* empty css                                                       *//* empty css                                                                 */const t="multi-step-native-form",n="0.0.1",s="module",o={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},r={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.28.0","@sveltejs/vite-plugin-svelte":"^6.1.2",svelte:"^5.38.1","svelte-check":"^4.3.1",typescript:"^5.9.2",vite:"^7.1.2"},a={"@sjsf/ajv8-validator":"^2.2.1","@sjsf/basic-theme":"^2.2.1","@sjsf/form":"^2.2.1","@sjsf/sveltekit":"^2.2.1",ajv:"^8.17.1"},i={name:t,private:!0,version:n,type:s,scripts:o,devDependencies:r,dependencies:a},m=`import { fail } from "@sveltejs/kit";
