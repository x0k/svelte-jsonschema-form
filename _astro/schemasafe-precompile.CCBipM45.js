...
`,"src/input-schema.json":_,"src/routes/patched-schema.ts":`import type { Schema } from "@sjsf/form";
...
return ([
  ...
  ref4,
  ref5
])})();`},Component:O,meta:{validator:{name:`schemasafe`,draft2020:!1,precompiled:!0},fields:[`multi-enum`],widgets:[`checkboxes`]}};export{k as default};