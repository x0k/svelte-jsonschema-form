...
`,o=e({default:()=>c,meta:()=>s}),s=t({category:r.UiExtension,title:`Decomposed Field`,description:`Complex field decomposed into reusable sub-components.`,tags:[i.CustomComponent]}),c=n({files:{"src/routes/+page.svelte":a}});export{s as n,o as t};