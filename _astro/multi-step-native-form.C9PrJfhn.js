import{o as e}from"./advanced-examples.CPs3c1-k.js";import"./_commonjsHelpers.BKBskBl2.js";import"./render.ZvVC14SW.js";import"./function.DAu9YZxj.js";import"./shared.y3pRYwqI.js";import"./preload-helper.CndyEa7M.js";import"./buttons.CA7BSKac.js";/* empty css                                                       *//* empty css                                                                 */const t="multi-step-native-form",n="0.0.1",s="module",o={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},r={"@sveltejs/adapter-auto":"^6.0.0","@sveltejs/kit":"^2.16.0","@sveltejs/vite-plugin-svelte":"^5.0.0",svelte:"^5.33.0","svelte-check":"^4.0.0",typescript:"^5.0.0",vite:"^6.2.6"},a={"@sjsf/ajv8-validator":"^2.1.1","@sjsf/basic-theme":"^2.1.1","@sjsf/form":"^2.1.1","@sjsf/sveltekit":"^2.1.1",ajv:"^8.17.1"},i={name:t,private:!0,version:n,type:s,scripts:o,devDependencies:r,dependencies:a},m=`import { fail } from "@sveltejs/kit";
