...
`,n=`import { createContext } from "svelte";
...
`,a={formDefaults:{widgets:[`file`]},files:{"src/routes/+page.svelte":e,"src/routes/[id]/+page.svelte":t,"src/routes/context.ts":n,"src/routes/form.svelte":r,"src/routes/stored-file-field.svelte":i}};export{a as layer};