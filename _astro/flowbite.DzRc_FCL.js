import{o as t}from"./advanced-examples.CEulQ5SC.js";import"./each.D9J1edTM.js";import"./render.CJVHSWjk.js";import"./definitions.CjwYPYqW.js";import"./_commonjsHelpers.DaWZu8wl.js";import"./snippet.StJGqR0u.js";import"./shared.DQz9udL4.js";import"./preload-helper.BUFao3bW.js";import"./buttons.Dia9lCGu.js";/* empty css                                                       *//* empty css                                                                 */const e="flowbite-starter",s="0.0.3",o="module",n={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},i={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.42.0","@sveltejs/vite-plugin-svelte":"^6.1.2",autoprefixer:"^10.4.21",flowbite:"^2.5.2",svelte:"^5.30.0","svelte-check":"^4.3.1",tailwindcss:"^3.4.18",postcss:"^8.5.6",typescript:"^5.9.2",vite:"^7.1.2"},c={"@sjsf/ajv8-validator":"workspace:*","@sjsf/basic-theme":"workspace:*","@sjsf/flowbite-theme":"workspace:*","@sjsf/form":"workspace:*",ajv:"^8.17.1","flowbite-svelte":"~0.47.4"},r={name:e,private:!0,version:s,type:o,scripts:n,devDependencies:i,dependencies:c},p=`import flowbite from 'flowbite/plugin';
