import"./index-client.1M4fv1JF.js";import{$t as e,Qt as t}from"./client.B0k3dZbu.js";import{Ht as n,i as r,u as i}from"./form.CvYxUx1h.js";import{M as a,i as o}from"./dist.CN2IrnoE.js";import{a as s,i as c}from"./demo.DGCkw8cG.js";import{n as l}from"./file-size.BlfDO_lq.js";function u(c,u){e(u,!0);let{defaults:d}=s();function f(e){return e.addKeyword({keyword:`maxSizeBytes`,validate(e,t){if(t===void 0)return!0;if(!(t instanceof File))throw Error(`Expected "File", but got "${typeof t}"`);return t.size<=e},error:{message:e=>`Max file size ${l(e.schema)}`}}),e}let p=i({...d,validator:e=>o({...e,ajvPlugins:e=>f(a(e))}),schema:{title:`File`,maxSizeBytes:1024*4},uiSchema:{"ui:components":{unknownField:`unknownNativeFileField`}},fieldsValidationMode:n});r(c,{get form(){return p}}),t()}var d={files:{"src/routes/+page.svelte":c(`<script lang="ts" module>
