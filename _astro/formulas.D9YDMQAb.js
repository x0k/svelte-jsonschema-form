import{o as e}from"./advanced-examples.Dt1wZFXc.js";import"./_commonjsHelpers.B6s2aKwq.js";import"./render.C2f5VKUu.js";import"./function.bEX8S1gg.js";import"./shared.C6Sl3ZLL.js";import"./preload-helper.BUFao3bW.js";import"./buttons.Dq8Tj-Dm.js";/* empty css                                                       *//* empty css                                                                 */const n="formulas",t="0.0.1",o="module",s={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},i={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.28.0","@sveltejs/vite-plugin-svelte":"^6.1.2","json-schema-to-ts":"^3.1.1",svelte:"^5.38.1","svelte-check":"^4.3.1",typescript:"^5.9.2",vite:"^7.1.2"},r={"@sjsf/ajv8-validator":"^2.2.1","@sjsf/basic-theme":"^2.2.1","@sjsf/form":"^2.2.1",ajv:"^8.17.1"},c={name:n,private:!0,version:t,type:o,scripts:s,devDependencies:i,dependencies:r},a=`<script lang="ts">
