import{o as e}from"./advanced-examples.Dbbzv3TJ.js";import"./each.CqbIHp8v.js";import"./render.1yt6JMB_.js";import"./definitions.BNjN-h6I.js";import"./_commonjsHelpers.DaWZu8wl.js";import"./snippet.DyeK7AWP.js";import"./shared.DgPR6oEm.js";import"./preload-helper.BUFao3bW.js";import"./buttons.DYkhIlmm.js";/* empty css                                                       *//* empty css                                                                 */const o="flowbite3-starter",r="0.0.9",s="module",c={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},t={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.49.5","@sveltejs/vite-plugin-svelte":"^6.1.2","@tailwindcss/vite":"^4.1.11",flowbite:"^3.1.2","flowbite-svelte":"^1.18.0",svelte:"^5.46.4","svelte-check":"^4.3.1",tailwindcss:"^4.1.11",typescript:"^5.9.2",vite:"^7.1.2"},n={"@sjsf/ajv8-validator":"workspace:*","@sjsf/basic-theme":"workspace:*","@sjsf/flowbite3-theme":"workspace:*","@sjsf/form":"workspace:*",ajv:"^8.17.1"},i={name:o,private:!0,version:r,type:s,scripts:c,devDependencies:t,dependencies:n},a=`@import "tailwindcss";
