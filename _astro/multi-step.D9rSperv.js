...
`,s=e({default:()=>l,meta:()=>c}),c=t({category:r.UiExtension,title:`Multi-step`,description:`Multi-step wizard form with navigation.`,tags:[i.Layout]}),l=n({files:{"src/routes/+page.svelte":a,"src/routes/multi-step-field.svelte":o}});export{s as n,c as t};