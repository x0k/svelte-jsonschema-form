var e={formDefaults:{widgets:[`file`]},files:{"src/routes/+page.svelte":`<script lang="ts">
...
`,"src/routes/context.ts":`import { createContext } from "svelte";
...
`,"src/routes/form.svelte":`<script lang="ts">
  import {
    createForm,
    BasicForm,
    type Schema,
...
<BasicForm {form} />
`,"src/routes/stored-file-field.svelte":`<script lang="ts" module>
