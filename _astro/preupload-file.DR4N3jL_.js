import{r as e}from"./rolldown-runtime.DAXXjFlN.js";import{a as t,i as n,n as r,r as i}from"./model.UVZZgLR2.js";var a=`<script lang="ts">
...
`,s=`import { createContext } from "svelte";
...
`,u=e({default:()=>f,meta:()=>d}),d=t({category:r.LogicExtension,title:`Pre-upload File`,description:`Custom file upload widget with client-side preview before submission.`,tags:[i.CustomComponent]}),f=n({widgets:[`file`],files:{"src/routes/+page.svelte":a,"src/routes/[id]/+page.svelte":o,"src/routes/context.ts":s,"src/routes/form.svelte":c,"src/routes/stored-file-field.svelte":l}});export{u as n,d as t};