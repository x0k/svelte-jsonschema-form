import"./index-client.Pqo5EW-P.js";import{Xt as e,Yt as t}from"./client.Cb7crF4c.js";import{Ht as n,i as r,u as i}from"./form.B5NxhwOh.js";import{i as a,n as o}from"./dist.DoOJQj8Z.js";import{n as s,t as c}from"./demo.Cnu-2gYI.js";import{n as l}from"./file-size.Cg3piZTA.js";function u(c,u){e(u,!0);let{defaults:d}=s();function f(e){return e.addKeyword({keyword:`maxSizeBytes`,validate(e,t){if(t===void 0)return!0;if(!(t instanceof File))throw Error(`Expected "File", but got "${typeof t}"`);return t.size<=e},error:{message:e=>`Max file size ${l(e.schema)}`}}),e}let p=i({...d,validator:e=>o({...e,ajvPlugins:e=>f(a(e))}),schema:{title:`File`,maxSizeBytes:1024*4},uiSchema:{"ui:components":{unknownField:`unknownNativeFileField`}},fieldsValidationMode:n});r(c,{get form(){return p}}),t()}var d={files:{"src/routes/+page.svelte":c(`<script lang="ts" module>
