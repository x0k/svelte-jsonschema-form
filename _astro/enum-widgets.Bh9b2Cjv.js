import{r as e}from"./rolldown-runtime.DAXXjFlN.js";import{a as t,i as n,n as r,r as i}from"./model.UVZZgLR2.js";var a=`<script lang="ts" module>
...
{#if isOther}
  ...
  />
{/if}
`,s=e({default:()=>l,meta:()=>c}),c=t({category:r.UiExtension,title:`Enum Widgets`,description:`Different widget types for enum properties.`,tags:[i.Enum,i.CustomComponent]}),l=n({files:{"src/routes/+page.svelte":a,"src/routes/radio-with-other.svelte":o}});export{c as n,s as t};