import{n as e}from"./shared.DQnOHn_8.js";import{a as t}from"./layer.CostUg3E.js";import{t as n}from"./package.BCY5EkHc.js";import{t as r}from"./server.DrxXEAes.js";var i=`export const trailingSlash = "always";`,a=`<script lang="ts">
...
`,c={package:t(n),formDefaults:{idBuilderPackage:e},files:{"src/lib/server.ts":r,"src/routes/+layout.ts":i,"src/routes/+page.svelte":a,"src/routes/data.remote.ts":o,"src/routes/[id]/+page.svelte":s},vite:{optimizeDeps:{exclude:[`@sjsf/form`,`@sjsf/sveltekit/rf/client`]}}};export{c as layer};