import{r as e}from"./rolldown-runtime.C0FnF6B9.js";import"./index-client.BHKBF-tO.js";import{Et as t,Mt as n,Nt as r,Pt as i,et as a,lt as o,nn as s,st as c,tn as l}from"./client.DYWvmWCR.js";import{i as u,u as d}from"./playground.CDaQ5EvV.js";import{X as f,i as p,u as m}from"./form.CbgrcR1Z.js";import{a as h,i as g}from"./demo.CcnckxZH.js";import{t as _}from"./precompile.B8RKlFvR.js";import{t as v}from"./input-schema.D8cf2JKT.js";var y={title:`User`,type:`object`,required:[`id`,`email`,`age`,`roles`],properties:{id:{type:`integer`,minimum:1,$id:`v1`},email:{type:`string`,format:`email`,$id:`v2`},age:{type:`integer`,minimum:21,maximum:100,$id:`v3`},roles:{type:`array`,items:{type:`string`,enum:[`admin`,`editor`,`viewer`],$id:`v5`},uniqueItems:!0,minItems:1,$id:`v4`}},additionalProperties:!1,$id:`v0`},b=e({v0:()=>V,v1:()=>w,v2:()=>D,v3:()=>j,v4:()=>L,v5:()=>P}),x=(e,t)=>()=>{try{return t||e((t={exports:{}}).exports,t),t.exports}catch(e){throw t=0,e}},S=x((e,t)=>{t.exports=function e(t,n){if(t===n)return!0;if(t&&n&&typeof t==`object`&&typeof n==`object`){if(t.constructor!==n.constructor)return!1;var r,i,a;if(Array.isArray(t)){if(r=t.length,r!=n.length)return!1;for(i=r;i--!==0;)if(!e(t[i],n[i]))return!1;return!0}if(t.constructor===RegExp)return t.source===n.source&&t.flags===n.flags;if(t.valueOf!==Object.prototype.valueOf)return t.valueOf()===n.valueOf();if(t.toString!==Object.prototype.toString)return t.toString()===n.toString();if(a=Object.keys(t),r=a.length,r!==Object.keys(n).length)return!1;for(i=r;i--!==0;)if(!Object.prototype.hasOwnProperty.call(n,a[i]))return!1;for(i=r;i--!==0;){var o=a[i];if(!e(t[o],n[o]))return!1}return!0}return t!==t&&n!==n}}),C=x(e=>{Object.defineProperty(e,"__esModule",{value:!0});var t=S();t.code=`require("ajv/dist/runtime/equal").default`,e.default=t}),w=E,T={type:`integer`,minimum:1,$id:`v1`};function E(e,{instancePath:t=``,parentData:n,parentDataProperty:r,rootData:i=e}={}){let a=null,o=0;if(typeof e!=`number`||e%1||isNaN(e)){let n={instancePath:t,schemaPath:`#/type`,keyword:`type`,params:{type:`integer`},message:`must be integer`,schema:T.type,parentSchema:T,data:e};a===null?a=[n]:a.push(n),o++}if(typeof e==`number`&&(e<1||isNaN(e))){let n={instancePath:t,schemaPath:`#/minimum`,keyword:`minimum`,params:{comparison:`>=`,limit:1},message:`must be >= 1`,schema:1,parentSchema:T,data:e};a===null?a=[n]:a.push(n),o++}return E.errors=a,o===0}var D=A,O={type:`string`,format:`email`,$id:`v2`},k=/^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/i;function A(e,{instancePath:t=``,parentData:n,parentDataProperty:r,rootData:i=e}={}){let a=null,o=0;if(typeof e==`string`){if(!k.test(e)){let n={instancePath:t,schemaPath:`#/format`,keyword:`format`,params:{format:`email`},message:`must match format "email"`,schema:`email`,parentSchema:O,data:e};a===null?a=[n]:a.push(n),o++}}else{let n={instancePath:t,schemaPath:`#/type`,keyword:`type`,params:{type:`string`},message:`must be string`,schema:O.type,parentSchema:O,data:e};a===null?a=[n]:a.push(n),o++}return A.errors=a,o===0}var j=N,M={type:`integer`,minimum:21,maximum:100,$id:`v3`};function N(e,{instancePath:t=``,parentData:n,parentDataProperty:r,rootData:i=e}={}){let a=null,o=0;if(typeof e!=`number`||e%1||isNaN(e)){let n={instancePath:t,schemaPath:`#/type`,keyword:`type`,params:{type:`integer`},message:`must be integer`,schema:M.type,parentSchema:M,data:e};a===null?a=[n]:a.push(n),o++}if(typeof e==`number`){if(e>100||isNaN(e)){let n={instancePath:t,schemaPath:`#/maximum`,keyword:`maximum`,params:{comparison:`<=`,limit:100},message:`must be <= 100`,schema:100,parentSchema:M,data:e};a===null?a=[n]:a.push(n),o++}if(e<21||isNaN(e)){let n={instancePath:t,schemaPath:`#/minimum`,keyword:`minimum`,params:{comparison:`>=`,limit:21},message:`must be >= 21`,schema:21,parentSchema:M,data:e};a===null?a=[n]:a.push(n),o++}}return N.errors=a,o===0}var P=I,F={type:`string`,enum:[`admin`,`editor`,`viewer`],$id:`v5`};function I(e,{instancePath:t=``,parentData:n,parentDataProperty:r,rootData:i=e}={}){let a=null,o=0;if(typeof e!=`string`){let n={instancePath:t,schemaPath:`#/type`,keyword:`type`,params:{type:`string`},message:`must be string`,schema:F.type,parentSchema:F,data:e};a===null?a=[n]:a.push(n),o++}if(e!==`admin`&&e!==`editor`&&e!==`viewer`){let n={instancePath:t,schemaPath:`#/enum`,keyword:`enum`,params:{allowedValues:F.enum},message:`must be equal to one of the allowed values`,schema:F.enum,parentSchema:F,data:e};a===null?a=[n]:a.push(n),o++}return I.errors=a,o===0}var L=B,R={type:`array`,items:{$ref:`v5#`},uniqueItems:!0,minItems:1,$id:`v4`},z=C().default;function B(e,{instancePath:t=``,parentData:n,parentDataProperty:r,rootData:i=e}={}){let a=null,o=0;if(Array.isArray(e)){if(e.length<1){let n={instancePath:t,schemaPath:`#/minItems`,keyword:`minItems`,params:{limit:1},message:`must NOT have fewer than 1 items`,schema:1,parentSchema:R,data:e};a===null?a=[n]:a.push(n),o++}let n=e.length;for(let r=0;r<n;r++){let n=e[r];if(typeof n!=`string`){let e={instancePath:t+`/`+r,schemaPath:`v5#/type`,keyword:`type`,params:{type:`string`},message:`must be string`,schema:F.type,parentSchema:F,data:n};a===null?a=[e]:a.push(e),o++}if(n!==`admin`&&n!==`editor`&&n!==`viewer`){let e={instancePath:t+`/`+r,schemaPath:`v5#/enum`,keyword:`enum`,params:{allowedValues:F.enum},message:`must be equal to one of the allowed values`,schema:F.enum,parentSchema:F,data:n};a===null?a=[e]:a.push(e),o++}}let r=e.length,i;if(r>1){e:for(;r--;)for(i=r;i--;)if(z(e[r],e[i])){let n={instancePath:t,schemaPath:`#/uniqueItems`,keyword:`uniqueItems`,params:{i:r,j:i},message:`must NOT have duplicate items (items ## `+i+` and `+r+` are identical)`,schema:!0,parentSchema:R,data:e};a===null?a=[n]:a.push(n),o++;break e}}}else{let n={instancePath:t,schemaPath:`#/type`,keyword:`type`,params:{type:`array`},message:`must be array`,schema:R.type,parentSchema:R,data:e};a===null?a=[n]:a.push(n),o++}return B.errors=a,o===0}var V=U,H={title:`User`,type:`object`,required:[`id`,`email`,`age`,`roles`],properties:{id:{$ref:`v1#`},email:{$ref:`v2#`},age:{$ref:`v3#`},roles:{$ref:`v4#`}},additionalProperties:!1,$id:`v0`};function U(e,{instancePath:t=``,parentData:n,parentDataProperty:r,rootData:i=e}={}){let a=null,o=0;if(e&&typeof e==`object`&&!Array.isArray(e)){if(e.id===void 0){let n={instancePath:t,schemaPath:`#/required`,keyword:`required`,params:{missingProperty:`id`},message:`must have required property 'id'`,schema:H.required,parentSchema:H,data:e};a===null?a=[n]:a.push(n),o++}if(e.email===void 0){let n={instancePath:t,schemaPath:`#/required`,keyword:`required`,params:{missingProperty:`email`},message:`must have required property 'email'`,schema:H.required,parentSchema:H,data:e};a===null?a=[n]:a.push(n),o++}if(e.age===void 0){let n={instancePath:t,schemaPath:`#/required`,keyword:`required`,params:{missingProperty:`age`},message:`must have required property 'age'`,schema:H.required,parentSchema:H,data:e};a===null?a=[n]:a.push(n),o++}if(e.roles===void 0){let n={instancePath:t,schemaPath:`#/required`,keyword:`required`,params:{missingProperty:`roles`},message:`must have required property 'roles'`,schema:H.required,parentSchema:H,data:e};a===null?a=[n]:a.push(n),o++}for(let n in e)if(n!==`id`&&n!==`email`&&n!==`age`&&n!==`roles`){let r={instancePath:t,schemaPath:`#/additionalProperties`,keyword:`additionalProperties`,params:{additionalProperty:n},message:`must NOT have additional properties`,schema:!1,parentSchema:H,data:e};a===null?a=[r]:a.push(r),o++}if(e.id!==void 0){let n=e.id;if(typeof n!=`number`||n%1||isNaN(n)){let e={instancePath:t+`/id`,schemaPath:`v1#/type`,keyword:`type`,params:{type:`integer`},message:`must be integer`,schema:T.type,parentSchema:T,data:n};a===null?a=[e]:a.push(e),o++}if(typeof n==`number`&&(n<1||isNaN(n))){let e={instancePath:t+`/id`,schemaPath:`v1#/minimum`,keyword:`minimum`,params:{comparison:`>=`,limit:1},message:`must be >= 1`,schema:1,parentSchema:T,data:n};a===null?a=[e]:a.push(e),o++}}if(e.email!==void 0){let n=e.email;if(typeof n==`string`){if(!k.test(n)){let e={instancePath:t+`/email`,schemaPath:`v2#/format`,keyword:`format`,params:{format:`email`},message:`must match format "email"`,schema:`email`,parentSchema:O,data:n};a===null?a=[e]:a.push(e),o++}}else{let e={instancePath:t+`/email`,schemaPath:`v2#/type`,keyword:`type`,params:{type:`string`},message:`must be string`,schema:O.type,parentSchema:O,data:n};a===null?a=[e]:a.push(e),o++}}if(e.age!==void 0){let n=e.age;if(typeof n!=`number`||n%1||isNaN(n)){let e={instancePath:t+`/age`,schemaPath:`v3#/type`,keyword:`type`,params:{type:`integer`},message:`must be integer`,schema:M.type,parentSchema:M,data:n};a===null?a=[e]:a.push(e),o++}if(typeof n==`number`){if(n>100||isNaN(n)){let e={instancePath:t+`/age`,schemaPath:`v3#/maximum`,keyword:`maximum`,params:{comparison:`<=`,limit:100},message:`must be <= 100`,schema:100,parentSchema:M,data:n};a===null?a=[e]:a.push(e),o++}if(n<21||isNaN(n)){let e={instancePath:t+`/age`,schemaPath:`v3#/minimum`,keyword:`minimum`,params:{comparison:`>=`,limit:21},message:`must be >= 21`,schema:21,parentSchema:M,data:n};a===null?a=[e]:a.push(e),o++}}}e.roles!==void 0&&(B(e.roles,{instancePath:t+`/roles`,parentData:e,parentDataProperty:`roles`,rootData:i})||(a=a===null?B.errors:a.concat(B.errors),o=a.length))}else{let n={instancePath:t,schemaPath:`#/type`,keyword:`type`,params:{type:`object`},message:`must be object`,schema:H.type,parentSchema:H,data:e};a===null?a=[n]:a.push(n),o++}return U.errors=a,o===0}var W=o(`<!> <pre> </pre>`,1);function G(e,o){s(o,!0);let{defaults:g}=h(),v=m({...g,schema:y,validator:_({validatorRetriever:d(b)}),fieldsValidationMode:11,resolver:u});var x=W(),S=n(x);p(S,{get form(){return v},novalidate:!0});var C=i(S,2),w=r(C,!0);t(e=>a(w,e),[()=>JSON.stringify(f(v),null,2)]),c(e,x),l()}var K={files:{"src/routes/+page.svelte":g(`<script lang="ts">
...
`},Component:G,meta:{validator:{name:`ajv8`,draft2020:!1,precompiled:!0},fields:[`multi-enum`],widgets:[`checkboxes`]}};export{K as default};