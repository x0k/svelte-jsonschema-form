var e={files:{"src/lib/tabs/context.svelte.ts":`import type { PathTrieRef } from "@sjsf/form";
...
`,"src/lib/tabs/layout.svelte":`<script lang="ts">
...
{:else if !(props.type === "array-field-meta" && isTuple)}
  <Layout {...props} />
{/if}
`,"src/lib/tabs/schema.ts":`import type { Schema } from '@sjsf/form';
...
`,"src/lib/tabs/tabs.svelte":`<script lang="ts">
...
{/if} -->
`,"src/lib/tabs/focus.ts":`import type { FailureValidationResult, FormState } from "@sjsf/form";
import {
...
`,"src/lib/tabs/tab.svelte":`<script lang="ts">
...
<\/script>
`,"src/lib/tabs/index.ts":`export * from './context.svelte'
export * from './focus'
export * from './schema'
export { default as Layout } from './layout.svelte'
`,"src/routes/sub-tabs.svelte":`<script lang="ts">
...
<Form />
`,"src/routes/top-tabs.svelte":`<script lang="ts">
