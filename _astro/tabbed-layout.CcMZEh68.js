var e=`import type { PathTrieRef } from "@sjsf/form";
...
{/if} -->
`,i=`import type { FailureValidationResult, FormState } from "@sjsf/form";
import {
...
<BasicForm {form} novalidate />
`,u={files:{"src/lib/tabs/context.svelte.ts":e,"src/lib/tabs/layout.svelte":t,"src/lib/tabs/schema.ts":n,"src/lib/tabs/tabs.svelte":r,"src/lib/tabs/focus.ts":i,"src/lib/tabs/tab.svelte":a,"src/lib/tabs/index.ts":o,"src/routes/sub-tabs.svelte":s,"src/routes/+page.svelte":c,"src/routes/top-tabs.svelte":l}};export{u as layer};