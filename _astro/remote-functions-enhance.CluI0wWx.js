import{r as e}from"./rolldown-runtime.C0FnF6B9.js";import{a as t,c as n,i as r,n as i,r as a}from"./model.DA5oU76I.js";import{t as o}from"./post.DblLiz6z.js";var s=`<script lang="ts">
...
`,l=e({default:()=>d,meta:()=>u}),u=t({category:i.SvelteKitIntegrations,title:`Remote Functions Enhance`,description:`Progressively enhanced remote functions.`,tags:[a.RemoteFunctions]}),d=r({sveltekit:`remoteFunctions`,files:{"src/lib/post.ts":o,"src/routes/data.remote.ts":c,"src/routes/+page.svelte":s},codeTransformers:[n],widgets:[`textarea`]});export{l as n,u as t};