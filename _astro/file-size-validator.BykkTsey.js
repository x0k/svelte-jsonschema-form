import"./index-client.CkrqgRIv.js";import{Xt as e,Yt as t}from"./client.BXzhBlXN.js";import{i as n,u as r}from"./form.D74qHMvd.js";import{n as i,t as a}from"./demo.6LNVQqAK.js";import{n as o,t as s}from"./file-size.BZgdoukZ.js";function c(a,c){e(c,!0);let{defaults:l}=i(),u=r({...l,validator:e=>({...l.validator(e),...s(({file:e,maxSizeBytes:t})=>`File ${e.name} is too large, max file size ${o(t)}`,e)}),schema:{type:`string`,title:`File`,format:`data-url`},uiSchema:{"ui:components":{stringField:`fileField`},"ui:options":{maxFileSizeBytes:4096}}});n(a,{get form(){return u}}),t()}var l={files:{"src/routes/+page.svelte":a(`<script>
