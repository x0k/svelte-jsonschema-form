...
/>
`,s=e({default:()=>l,meta:()=>c}),c=t({category:r.LogicExtension,title:`Nullable Fields`,description:`Custom nullable field component for null value states.`,tags:[i.CustomComponent]}),l=n({files:{"src/routes/+page.svelte":a,"src/routes/nullable-field.svelte":o}});export{s as n,c as t};