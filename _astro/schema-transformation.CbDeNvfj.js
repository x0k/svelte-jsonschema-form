...
/>
`,o=e({default:()=>c,meta:()=>s}),s=t({category:r.LogicExtension,title:`Schema Transformation`,description:`JSON Schema transformation before form rendering.`,tags:[i.Schema]}),c=n({files:{"src/routes/+page.svelte":a}});export{o as n,s as t};