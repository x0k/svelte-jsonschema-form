import{o as t}from"./advanced-examples.iOT6f5Qv.js";import"./each.BMERpw53.js";import"./render.C83cpEEf.js";import"./definitions.C59jdWoE.js";import"./_commonjsHelpers.DaWZu8wl.js";import"./snippet.BHClqOtQ.js";import"./shared.CCMRC-1K.js";import"./preload-helper.BUFao3bW.js";import"./buttons.CveNAgEY.js";/* empty css                                                       *//* empty css                                                                 */const n="shadcn-starter",r="0.0.9",e="module",a={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},o={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.49.5","@sveltejs/vite-plugin-svelte":"^6.1.2",autoprefixer:"^10.4.21",svelte:"^5.46.4","svelte-check":"^4.3.1",tailwindcss:"^3.4.18",postcss:"^8.5.6",typescript:"^5.9.2",vite:"^7.1.2"},s={"@internationalized/date":"^3.8.1","@lucide/svelte":"^0.501.0","@sjsf/ajv8-validator":"workspace:*","@sjsf/basic-theme":"workspace:*","@sjsf/shadcn-theme":"workspace:*","@sjsf/form":"workspace:*",ajv:"^8.17.1","bits-ui":"^2.2.0",clsx:"^2.1.0","tailwind-merge":"^2.6.0","tailwind-variants":"^0.3.0","tailwindcss-animate":"^1.0.7"},i={name:n,private:!0,version:r,type:e,scripts:a,devDependencies:o,dependencies:s},c=`@tailwind base;
@tailwind components;
@tailwind utilities;
