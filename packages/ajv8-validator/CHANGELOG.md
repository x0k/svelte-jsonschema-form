...
- Add `localize` validator option ([#396](https://github.com/x0k/svelte-jsonschema-form/pull/396))
...
- Add `Ajv` option to override ajv constructor ([#349](https://github.com/x0k/svelte-jsonschema-form/pull/349))
...
- df89d87: Replace `createFormValidator` with `createFormValidatorFactory` in precompiled submodules
...
- Replace `createFormValidator` with `createFormValidatorFactory` in precompiled submodules ([#198](https://github.com/x0k/svelte-jsonschema-form/pull/198))
...
- Fix async fields validation ([`7458946`](https://github.com/x0k/svelte-jsonschema-form/commit/745894612d726cd5ceb74640a19620361967aab3))
...
- Fix async fields validation ([#83](https://github.com/x0k/svelte-jsonschema-form/pull/83))
...
- Migrate to `isSchemaDeepEqual` ([#55](https://github.com/x0k/svelte-jsonschema-form/pull/55))
