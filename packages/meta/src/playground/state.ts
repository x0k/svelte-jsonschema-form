...
export type PlaygroundValidator = Exclude<
  JsonSchemaValidator,
  PrecompiledOnlyValidator
>;

export type PlaygroundTheme = Exclude<Theme, LegacyTheme | ThemeExtension>;
...
export type PlaygroundPreset = Pick<PlaygroundState, RequiredSampleProperties> &
