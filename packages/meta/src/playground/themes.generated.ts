...
import { theme as skeleton5Base } from "@sjsf/skeleton5-theme";
import skeleton5_checkboxesWidget from "@sjsf/skeleton5-theme/extra-widgets/checkboxes.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/checkboxes.svelte";
import skeleton5_comboboxWidget from "@sjsf/skeleton5-theme/extra-widgets/combobox.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/combobox.svelte";
import skeleton5_datePickerWidget from "@sjsf/skeleton5-theme/extra-widgets/date-picker.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/date-picker.svelte";
import skeleton5_dateRangePickerWidget from "@sjsf/skeleton5-theme/extra-widgets/date-range-picker.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/date-range-picker.svelte";
import skeleton5_skeleton5FileUploadWidget from "@sjsf/skeleton5-theme/extra-widgets/file-upload.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/file-upload.svelte";
import skeleton5_fileWidget from "@sjsf/skeleton5-theme/extra-widgets/file.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/file.svelte";
import skeleton5_multiSelectWidget from "@sjsf/skeleton5-theme/extra-widgets/multi-select.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/multi-select.svelte";
import skeleton5_radioButtonsWidget from "@sjsf/skeleton5-theme/extra-widgets/radio-buttons.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/radio-buttons.svelte";
import skeleton5_radioWidget from "@sjsf/skeleton5-theme/extra-widgets/radio.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/radio.svelte";
import skeleton5_rangeSliderWidget from "@sjsf/skeleton5-theme/extra-widgets/range-slider.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/range-slider.svelte";
import skeleton5_rangeWidget from "@sjsf/skeleton5-theme/extra-widgets/range.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/range.svelte";
import skeleton5_ratingWidget from "@sjsf/skeleton5-theme/extra-widgets/rating.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/rating.svelte";
import skeleton5_skeleton5SliderWidget from "@sjsf/skeleton5-theme/extra-widgets/slider.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/slider.svelte";
import skeleton5_switchWidget from "@sjsf/skeleton5-theme/extra-widgets/switch.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/switch.svelte";
import skeleton5_tagsWidget from "@sjsf/skeleton5-theme/extra-widgets/tags.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/tags.svelte";
import skeleton5_textareaWidget from "@sjsf/skeleton5-theme/extra-widgets/textarea.svelte";
import "@sjsf/skeleton5-theme/extra-widgets/textarea.svelte";
export const skeleton5Theme = extendByRecord(skeleton5Base, {
  ...fields,
  checkboxesWidget: skeleton5_checkboxesWidget,
  comboboxWidget: skeleton5_comboboxWidget,
  datePickerWidget: skeleton5_datePickerWidget,
  dateRangePickerWidget: skeleton5_dateRangePickerWidget,
  skeleton5FileUploadWidget: skeleton5_skeleton5FileUploadWidget,
  fileWidget: skeleton5_fileWidget,
  multiSelectWidget: skeleton5_multiSelectWidget,
  radioButtonsWidget: skeleton5_radioButtonsWidget,
  radioWidget: skeleton5_radioWidget,
  rangeSliderWidget: skeleton5_rangeSliderWidget,
  rangeWidget: skeleton5_rangeWidget,
  ratingWidget: skeleton5_ratingWidget,
  skeleton5SliderWidget: skeleton5_skeleton5SliderWidget,
  switchWidget: skeleton5_switchWidget,
  tagsWidget: skeleton5_tagsWidget,
  textareaWidget: skeleton5_textareaWidget
});
