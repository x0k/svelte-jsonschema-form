...
export interface AbstractUOperator<
  T extends UOperatorType,
> extends AbstractOperator<T> {
  operand: OperatorNode | undefined;
}

export interface AbstractNOperator<
  T extends NOperatorType,
> extends AbstractOperator<T> {
  operands: OperatorNode[];
}

export interface AbstractSOperator<
  T extends SOperatorType,
> extends AbstractOperator<T> {
  value: string;
}
...
export interface ObjectNode extends AbstractCustomizableNode<
  NodeType.Object,
  ObjectOptions
> {
  properties: ObjectPropertyNode[];
...
export interface ArrayNode extends AbstractCustomizableNode<
  NodeType.Array,
  ArrayNodeOptions
> {
  item: Node | undefined;
...
export interface GridNode extends AbstractCustomizableNode<
  NodeType.Grid,
  GridNodeOptions
> {
  width: number;
...
export interface EnumNode extends AbstractCustomizableNode<
  NodeType.Enum,
  EnumOptions
> {
...
export interface BooleanNode extends AbstractCustomizableNode<
  NodeType.Boolean,
  BooleanOptions
> {}
...
export interface FileNode extends AbstractCustomizableNode<
  NodeType.File,
  FileOptions
> {}
...
export interface TagsNode extends AbstractCustomizableNode<
  NodeType.Tags,
  TagsOptions
> {}
...
export type NodeOverridesMap = {
  [T in CustomizableNodeType]?: Partial<
    Extract<CustomizableNode, AbstractNode<T>>["options"]
  >;
};
