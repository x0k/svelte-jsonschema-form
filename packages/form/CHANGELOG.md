...
- Export `createFormValidator` and `createAsyncFormValidator` functions from `@sjsf/form/validators/standard-schema` ([#379](https://github.com/x0k/svelte-jsonschema-form/pull/379))
...
- Port https://github.com/rjsf-team/react-jsonschema-form/pull/5050 ([#372](https://github.com/x0k/svelte-jsonschema-form/pull/372))
...
- Fix errors iterator ([#254](https://github.com/x0k/svelte-jsonschema-form/pull/254))
