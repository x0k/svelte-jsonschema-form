...
- Use robust UI schema proxying ([#357](https://github.com/x0k/svelte-jsonschema-form/pull/357))
...
- a42eafe: Omit empty files during FormData parsing
- 95fd46c: Handle transformation during validation
