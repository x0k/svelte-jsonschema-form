...
- Fix `switch` extra widget typings ([#390](https://github.com/x0k/svelte-jsonschema-form/pull/390))
...
- Update shadcn components (03.04.2026) ([#346](https://github.com/x0k/svelte-jsonschema-form/pull/346))

- Updated dependencies [[`d2b2317`](https://github.com/x0k/svelte-jsonschema-form/commit/d2b231748792215b46f17e8400251e3d581bda12), [`de8780b`](https://github.com/x0k/svelte-jsonschema-form/commit/de8780be745b9ca7503322d35e6501f00c455875), [`94c2d0c`](https://github.com/x0k/svelte-jsonschema-form/commit/94c2d0ca7f131ba4e790df7999661e309fdb923f), [`e1fcb52`](https://github.com/x0k/svelte-jsonschema-form/commit/e1fcb52a07a6ef05750e3f199068e73cadbc3239), [`e8619e4`](https://github.com/x0k/svelte-jsonschema-form/commit/e8619e4bf496be2c5bd1356e793dafdd6959400d), [`70cbcac`](https://github.com/x0k/svelte-jsonschema-form/commit/70cbcaceb5400446130bcd336d7af01a92ab2027), [`a9f6cc1`](https://github.com/x0k/svelte-jsonschema-form/commit/a9f6cc12e077b195ac9f9c75cb5f7c0f21d6b16a), [`b5786cf`](https://github.com/x0k/svelte-jsonschema-form/commit/b5786cfd0e2675d6ae55a197fb8f0f48a9afc77c)]:
  - @sjsf/form@3.4.0
...
- Remove redundant stabilization logic ([#323](https://github.com/x0k/svelte-jsonschema-form/pull/323))
...
- Update shadcn components (14.02.2026) ([#321](https://github.com/x0k/svelte-jsonschema-form/pull/321))

- Allow `@lucide/svelte@0.564.0` ([#321](https://github.com/x0k/svelte-jsonschema-form/pull/321))
...
- Fix the display of `*` in field titles ([#281](https://github.com/x0k/svelte-jsonschema-form/pull/281))
...
- 40e924f: Allow overwriting of default handlers using the `onsubmit` and `onreset` attributes
- f90e630: - Use `Field`, `FieldLabel`, `FieldSet`, `FieldContent`, `FieldDescription`, `FieldError`, `FieldTitle`, `FieldLegend` components
  - Use `data-invalid` and `aria-invalid` attributes
- 80201e6: - Use `ButtonGroup` component for `array-item-controls` layout
  - Use `outline` variant for non-submit buttons
- 0201f5e: Bump `buits-ui` minimal version to `^2.10.0`

### Patch Changes

- 4218c7c: Allow to use `tailwind-variants@^3.0.0`
- d54be5e: Fix adding event handlers to trigger validation
...
- - Use `Field`, `FieldLabel`, `FieldSet`, `FieldContent`, `FieldDescription`, `FieldError`, `FieldTitle`, `FieldLegend` components ([#214](https://github.com/x0k/svelte-jsonschema-form/pull/214))
  - Use `data-invalid` and `aria-invalid` attributes

- - Use `ButtonGroup` component for `array-item-controls` layout ([#214](https://github.com/x0k/svelte-jsonschema-form/pull/214))
  - Use `outline` variant for non-submit buttons
...
- Bump `buits-ui` minimal version to `^2.10.0` ([#202](https://github.com/x0k/svelte-jsonschema-form/pull/202))

### Patch Changes

- Allow to use `tailwind-variants@^3.0.0` ([#202](https://github.com/x0k/svelte-jsonschema-form/pull/202))
...
- Make `optional` dependencies optional `peer` dependencies ([#183](https://github.com/x0k/svelte-jsonschema-form/pull/183))

- Update all default components (1.09.2025) ([#183](https://github.com/x0k/svelte-jsonschema-form/pull/183))
...
- Fix item alignment in `object-property` layout ([`f8278d1`](https://github.com/x0k/svelte-jsonschema-form/commit/f8278d1c60bdf954e8455ba7a9009481348f44ab))
...
- Change widget type from `selectWidget` to `comboboxWidget` for combobox widget ([`c7601fc`](https://github.com/x0k/svelte-jsonschema-form/commit/c7601fcdedbc60e9e1546c302248408fb4155ca7))
...
- Add `@sjsf/shadcn4-theme` package ([#109](https://github.com/x0k/svelte-jsonschema-form/pull/109))

### Patch Changes

- Fix missing extra widgets ([`8e9c082`](https://github.com/x0k/svelte-jsonschema-form/commit/8e9c082fe3cd2952d7d78dd0b5f181ebe8c8fe41))

- Update components (10.06.2025) ([`66a6d00`](https://github.com/x0k/svelte-jsonschema-form/commit/66a6d00efe15b0f56d5c5b3bb8bcf15aff917586))
