...
- Replace `SimpleForm` with `BasicForm` from `@sjsf/form` package

  - In most cases you may remove additional styles/classes because `BasicForm` uses
...
- Replace `useForm2` with `createForm`
