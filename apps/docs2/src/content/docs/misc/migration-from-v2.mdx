...
And install `json-schema-merge-allof`, but I recommend trying to switch
to a modern merger to get the benefits of bundle size and performance -
[modern merger setup](../../guides/merger/).
