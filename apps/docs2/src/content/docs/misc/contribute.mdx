...
You can leave feedback on any aspect of the library (docs, DX, features, etc.)
in [GitHub discussions](https://github.com/x0k/svelte-jsonschema-form/discussions/351).
...
environment and [mk](https://github.com/x0k/mk), although `pnpm@11` will suffice
