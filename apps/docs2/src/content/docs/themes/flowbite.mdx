...
import { peerDependencies } from "#/flowbite-theme/package.json"
...
export const THEME_PACKAGE = "@sjsf/flowbite-theme@next"
...
<Code lang='ts' code={createExtraImports(THEME_PACKAGE, extraWidgets)} />
