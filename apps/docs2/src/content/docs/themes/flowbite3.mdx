...
import { PLAYGROUND_SJSF_THEME_STYLES } from 'meta/playground'
...
export const pkg = themePackage('flowbite3')
...
<Tabs>
  <TabItem label='Form'>
    <FormCard style={PLAYGROUND_SJSF_THEME_STYLES['flowbite3']}>
