...
export interface UiSchemaContent {
  ...
  "ui:components"?: Partial<{
    [T in FoundationalComponentType]:
      Exclude<CompatibleComponentType<T>, T> | ComponentDefinitions[T];
  }>;
...
<LinkCard
  ...
  description="Customize widgets, actions, and UI options"
  href={withBase("/guides/ui-customization/")}
/>
<LinkCard
  title="Labels and icons"
  description="Add translation and icon support to your forms"
