...
export function validator<T>(options: ValidatorFactoryOptions) {
  ...
  return {
    ...
    validateFormValue(formValue) {
      const errors = validator.validateFormValue(formValue);
      // Your logic
      return errors;
    },
...
export type ValidationResult<Output> =
  SuccessValidationResult<Output> | FailureValidationResult;
...
export type AnyFormValueValidator<Output> =
  FormValueValidator<Output> | AsyncFormValueValidator<Output>;
...
export type AnyFieldValueValidator =
  FieldValueValidator | AsyncFieldValueValidator;
...
<LinkCard
  title="Validation"
  description="Learn about form validation strategies"
  href={withBase("/guides/validation/")}
/>
<LinkCard
  title="File handling"
  description="Learn about file validation and handling"
  href={withBase("/guides/file-handling/")}
/>
