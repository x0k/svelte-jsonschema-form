...
const validators=[(function(R){var E=function(d){var _all=true;const _e=[];
  ...
  return{valid:_e.length===0,errors:_e}};return function(d){if(!Number.isInteger(d))return E(d)
  if(d<1)return E(d)
