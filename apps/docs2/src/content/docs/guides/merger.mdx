...
Starting with version 3, you must provide a `createMerger` option when creating forms to enable `FormMerger` instantiation.
This merger handles the combination and processing of JSON schemas within your forms.
