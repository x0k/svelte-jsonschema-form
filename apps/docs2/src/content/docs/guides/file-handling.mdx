...
See the <OpenInSandbox client:visible example="Pre-upload File" /> example for a working implementation.
...
<Demo name="custom-keyword" client:visible />
...
<Demo name="file-size-validator" client:visible />

<LinkCard
  title="Validator API Reference"
  description="Learn more about implementing custom validators"
  href={withBase("/form/validator/")}
/>
