...
<Deps hideOptional pkg={formPackage} />

## Usage

Let's start with the simplest setup:

<Demo name="simple-setup" theme="basic" client:visible />
...
<LinkCard title="Schema" href={withBase("/form/schema/")} />

<LinkCard title="Form options" href={withBase("/form/options/")} />
...
<Demo name="ui-schema" client:visible />

<LinkCard title="UI Schema" href={withBase("/form/ui-schema/")} />
...
<Demo name="form-state" client:visible />

<LinkCard title="Form state" href={withBase("/form/state/")} />
...
<Demo name="controlled-form" client:visible />
