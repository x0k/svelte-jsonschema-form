...
import modelCode from '%/sveltekit-starter/src/routes/model?raw'
...
- All validation errors are displayed on the root element -
  [feature request](https://github.com/sveltejs/kit/issues/14688)
- When using `createPost.fields.allIssues()`, the following error occurs:
  `Type 'RecursiveFormFields' has no call signatures` -
  [issue](https://github.com/sveltejs/kit/issues/14687)
