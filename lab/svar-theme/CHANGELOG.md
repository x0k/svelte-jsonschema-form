...
- Implement a label for the Switch widget ([#305](https://github.com/x0k/svelte-jsonschema-form/pull/305))

- Prevent form submission when changing the value in the `radio-buttons` widget ([#305](https://github.com/x0k/svelte-jsonschema-form/pull/305))
...
- Add `color-picker`, `color-select`, `combobox`, `radio-buttons` and `switch` widgets ([#269](https://github.com/x0k/svelte-jsonschema-form/pull/269))
