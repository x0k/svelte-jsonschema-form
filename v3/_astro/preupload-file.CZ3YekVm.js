...
`,t=`import { getContext, setContext } from "svelte";
...
`,r={formDefaults:{widgets:["file"]},files:{"src/routes/+page.svelte":n,"src/routes/[id]/+page.svelte":e,"src/routes/context.ts":t,"src/routes/form.svelte":o,"src/routes/stored-file-field.svelte":i}};export{r as layer};
