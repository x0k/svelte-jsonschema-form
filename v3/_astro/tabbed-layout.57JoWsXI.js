const e=`import type { PathTrieRef } from "@sjsf/form";
...
<BasicForm {form} novalidate />
`,b={files:{"src/lib/tabs/context.svelte.ts":e,"src/lib/tabs/layout.svelte":t,"src/lib/tabs/schema.ts":n,"src/lib/tabs/tabs.svelte":r,"src/lib/tabs/focus.ts":s,"src/lib/tabs/tab.svelte":o,"src/lib/tabs/index.ts":a,"src/routes/sub-tabs.svelte":i,"src/routes/+page.svelte":c,"src/routes/top-tabs.svelte":l}};export{b as layer};
