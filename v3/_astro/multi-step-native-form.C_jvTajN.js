import{o as e}from"./advanced-examples.BwplXmgI.js";import"./_commonjsHelpers.C50WZpYe.js";import"./render.ByIQ4bwk.js";import"./array.Be5mtBsQ.js";import"./shared.FzfvnCJP.js";import"./preload-helper.1-HTDuIo.js";import"./buttons.DPXeq3S0.js";/* empty css                                                       *//* empty css                                                                 */const t="multi-step-native-form",n="0.0.1",s="module",o={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},r={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.38.1","@sveltejs/vite-plugin-svelte":"^6.1.2",svelte:"^5.38.1","svelte-check":"^4.3.1",typescript:"^5.9.2",vite:"^7.1.2"},a={"@sjsf/ajv8-validator":"^3.0.0-next.1","@sjsf/basic-theme":"^3.0.0-next.1","@sjsf/form":"^3.0.0-next.1","@sjsf/sveltekit":"^3.0.0-next.1",ajv:"^8.17.1"},i={name:t,private:!0,version:n,type:s,scripts:o,devDependencies:r,dependencies:a},m=`import { fail } from "@sveltejs/kit";
...
`,E={package:e(i),files:{"src/routes/+page.server.ts":m,"src/routes/+page.svelte":p,"src/routes/model.ts":c}};export{E as layer};
