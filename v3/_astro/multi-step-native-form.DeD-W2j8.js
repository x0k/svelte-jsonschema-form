import{o as e}from"./advanced-examples.FHGKvaFr.js";import"./_commonjsHelpers.jSTVcZ1w.js";import"./render.BHiezTN2.js";import"./definitions.DlirAx7C.js";import"./snippet.7ZyTRIBg.js";import"./shared.CWXdVpU6.js";import"./preload-helper.1-HTDuIo.js";import"./buttons.CvusaXZ_.js";/* empty css                                                       *//* empty css                                                                 */const t="multi-step-native-form",n="0.0.1",s="module",o={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},r={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.46.0","@sveltejs/vite-plugin-svelte":"^6.1.2",svelte:"^5.39.0","svelte-check":"^4.3.1",typescript:"^5.9.2",vite:"^7.1.2"},a={"@sjsf/ajv8-validator":"^3.0.0-next.7","@sjsf/basic-theme":"^3.0.0-next.7","@sjsf/form":"^3.0.0-next.7","@sjsf/sveltekit":"^3.0.0-next.7",ajv:"^8.17.1"},i={name:t,private:!0,version:n,type:s,scripts:o,devDependencies:r,dependencies:a},p=`import { fail } from "@sveltejs/kit";
...
`,j={package:e(i),files:{"src/routes/+page.server.ts":p,"src/routes/+page.svelte":m,"src/routes/model.ts":c}};export{j as layer};
