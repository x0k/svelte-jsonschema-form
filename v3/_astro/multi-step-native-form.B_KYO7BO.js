import{o as e}from"./advanced-examples.IZRt6_bi.js";import"./each.CCbNYC82.js";import"./render.BDRr2Iv9.js";import"./definitions.Alz4DWWs.js";import"./_commonjsHelpers.DaWZu8wl.js";import"./snippet.DY_xRtDp.js";import"./shared.DCwJjTzT.js";import"./preload-helper.1-HTDuIo.js";import"./buttons.DwUW3yJp.js";/* empty css                                                       *//* empty css                                                                 */const t="multi-step-native-form",n="0.0.1",s="module",o={dev:"vite dev",preview:"vite preview",prepare:"svelte-kit sync || echo ''",check:"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json","check:watch":"svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch"},r={"@sveltejs/adapter-auto":"^6.1.0","@sveltejs/kit":"^2.46.0","@sveltejs/vite-plugin-svelte":"^6.1.2",svelte:"^5.40.0","svelte-check":"^4.3.1",typescript:"^5.9.2",vite:"^7.1.2"},a={"@sjsf/ajv8-validator":"^3.0.0-next.8","@sjsf/basic-theme":"^3.0.0-next.8","@sjsf/form":"^3.0.0-next.8","@sjsf/sveltekit":"^3.0.0-next.8",ajv:"^8.17.1"},i={name:t,private:!0,version:n,type:s,scripts:o,devDependencies:r,dependencies:a},p=`import { fail } from "@sveltejs/kit";
...
`,x={package:e(i),files:{"src/routes/+page.server.ts":p,"src/routes/+page.svelte":m,"src/routes/model.ts":c}};export{x as layer};
