...
<BasicForm {form} novalidate />
`,b={files:{"src/lib/tabs/context.svelte.ts":t,"src/lib/tabs/layout.svelte":e,"src/lib/tabs/schema.ts":n,"src/lib/tabs/tabs.svelte":r,"src/lib/tabs/focus.ts":o,"src/lib/tabs/tab.svelte":s,"src/lib/tabs/index.ts":a,"src/routes/sub-tabs.svelte":i,"src/routes/+page.svelte":c,"src/routes/top-tabs.svelte":l}};export{b as layer};
