...
<BasicForm {form} novalidate />
`,b={files:{"src/lib/tabs/context.svelte.ts":t,"src/lib/tabs/layout.svelte":e,"src/lib/tabs/schema.ts":n,"src/lib/tabs/tabs.svelte":r,"src/lib/tabs/focus.ts":s,"src/lib/tabs/tab.svelte":o,"src/lib/tabs/index.ts":a,"src/routes/sub-tabs.svelte":i,"src/routes/+page.svelte":l,"src/routes/top-tabs.svelte":c}};export{b as layer};
